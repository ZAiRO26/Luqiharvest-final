...
function BackToTopButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-24 left-8 z-50 bg-green-600 hover:bg-green-700 text-white p-3 rounded-full shadow-lg transition-all focus:outline-none animate-fade-bounce"
