          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4 text-2xl justify-center md:justify-start">
              ...
              <a href="https://www.linkedin.com/company/luqi-harvest/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-[#0077b5] transition-colors">
                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 8a6 6 0 0 1 6 6v6h-4v-6a2 2 0 0 0-4 0v6h-4v-6a6 6 0 0 1 6-6z"/><circle cx="8" cy="8" r="2"/></svg>
              </a>
          ...
          <div>
            ...
            <div className="space-y-2 text-[#3d372c] text-base">
              <div className="flex items-start space-x-2">
                ...
                <span>LUQI HARVEST EXPORTS<br/>Innov8 Mantri Commercio, Tower A, No.51, 5th Floor, Bengaluru, Karnataka, India – 560103</span>
              </div>
