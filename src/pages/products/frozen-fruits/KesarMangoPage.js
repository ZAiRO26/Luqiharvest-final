...
const description = `Frozen Kesar Mango is made from Kesar Mangoes, known for their saffron-like color and fragrant aroma. The frozen pulp is celebrated for its sweet flavor and pulpy texture, making it ideal for desserts, juices, and ice creams.`;
...
const KesarMangoPage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/FZ3-Kesar Mango.jpg"}
    name="Frozen Kesar Mango"
