...
const description = `Jackfruit, with its tropical sweet taste and fibrous texture, is used in jams, smoothies, candies, and traditional desserts. Its rich flavor and nutritional benefits make it a great choice for many culinary applications.`;
...
const JackfruitPage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/AS8-Jackfruit.jpg"}
    name="Jackfruit Pulp"
