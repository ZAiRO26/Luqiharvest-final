...
const description = `Sapota (Chikku) Concentrate is made from Sapota, also known as Chikku, which has a rich, malty flavor and soft, grainy texture. Perfect for milkshakes, smoothies, and desserts, it's naturally sweet and packed with nutrients.`;
...
const SapotaPage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/CT7-Sapota(Chikku).jpg"}
    name="Sapota (Chikku) Concentrate"
