...
const description = `White Guava Concentrate is made from white guava pulp, offering a delicate, mildly sweet flavor. Perfect for juices, smoothies, jams, and desserts.`;
...
const WhiteGuavaPage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/CT4-White Guava.jpg"}
