...
const description = `Pineapple Concentrate is made from ripe pineapples, offering a tangy and sweet flavor with a refreshing aroma. Perfect for juices, sauces, ice creams, and bakery products.`;
...
const PineapplePage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/CT6-Pineapple.jpg"}
