...
const description = `Jackfruit Concentrate is made from jackfruit, with its tropical sweet taste and fibrous texture. Used in jams, smoothies, candies, and traditional desserts with rich flavor and nutritional benefits.`;
...
const JackfruitPage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/CT8-Jackfruit.jpg"}
    name="Jackfruit Concentrate"
