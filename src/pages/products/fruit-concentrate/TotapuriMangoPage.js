...
const description = `Totapuri Mango Concentrate is made from Totapuri Mangoes, known for their vibrant yellow color and distinct tangy taste. The concentrate is perfect for juices, nectars, smoothies, and sauces.`;
...
const TotapuriMangoPage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/CT2-Totapuri Mango.jpg"}
