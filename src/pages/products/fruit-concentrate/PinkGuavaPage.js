...
const description = `Pink Guava Concentrate is made from pink guava pulp, offering a fruitier, tropical taste. Perfect for juices, smoothies, jams, and desserts.`;
...
const PinkGuavaPage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/CT5-Pink Guava.jpg"}
