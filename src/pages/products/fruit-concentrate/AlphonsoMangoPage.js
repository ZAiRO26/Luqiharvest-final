...
const description = `Alphonso Mango Concentrate is made from Alphonso Mangoes, often called the "King of Mangoes," prized for their deep golden color, rich creamy texture, and unparalleled sweetness. The concentrate is perfect for beverages, desserts, and food processing.`;
...
const AlphonsoMangoPage = () => (
  <ProductDetailLayout
    image={process.env.PUBLIC_URL + "/images/products/CT1-Alphanso Mango.jpg"}
    name="Alphonso Mango Concentrate"
