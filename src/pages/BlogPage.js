...
const BlogPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>LUQI HARVEST Blog - Industry Insights & Fruit Export Trends</title>
        <meta name="description" content="Stay updated with the latest trends, insights, and news in the fruit processing and export industry from LUQI HARVEST." />
        <meta name="keywords" content="fruit blog, industry insights, export trends, mango pulp, fruit processing, LUQI HARVEST" />
        <meta property="og:title" content="LUQI HARVEST Blog - Industry Insights & Fruit Export Trends" />
        <meta property="og:description" content="Stay updated with the latest trends, insights, and news in the fruit processing and export industry from LUQI HARVEST." />
        <meta property="og:image" content="/Blog-banner.jpg" />
        <meta property="og:url" content="https://luqi-harvest.com/blog" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="LUQI HARVEST Blog - Industry Insights & Fruit Export Trends" />
        <meta name="twitter:description" content="Stay updated with the latest trends, insights, and news in the fruit processing and export industry from LUQI HARVEST." />
        <meta name="twitter:image" content="/Blog-banner.jpg" />
      </Helmet>
